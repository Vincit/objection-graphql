...
class SchemaBuilder {
  ...
  extendWithMutations(mutationRootType) {
    if (!(mutationRootType instanceof GraphQLObjectType)) {
      throw new TypeError('mutationRootType should be of type GraphQLObjectType');
    }
